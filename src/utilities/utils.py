...
class ChamferDistance(nn.Module):
    ...
    def forward(self, x, y, normalize=False):
        ...
        normalize = normalize distance by number of pt-clouds.
        Arguments:
        ...
        if normalize:
            n = min_for_each_x_i.shape[1]
            m = min_for_each_y_j.shape[1]
            distance = min_for_each_x_i.sum(1) / n  + min_for_each_y_j.sum(1) / m  # shape [b]
        else:
